...
pub fn doc_type(ty: &TypeRef, lang: Language, ffi_prefix: &str) -> String {
    match ty {
        ...
        TypeRef::Bytes => match lang {
            ...
            Language::Ffi | Language::C => "const uint8_t*".to_string(),
        ...
        TypeRef::Map(k, v) => {
            ...
            match lang {
                ...
                Language::Ffi | Language::C => "void*".to_string(),
                    ...
                    match trimmed {
                        "usize" | "u64" | "u32" | "u16" | "u8" | "i64" | "i32" | "i16" | "i8" | "isize" => {
                            ...
                            match lang {
                                ...
                                Language::Ffi | Language::C => "uint64_t".to_string(),
...
pub(crate) fn doc_primitive(p: &PrimitiveType, lang: Language) -> String {
    match lang {
        ...
        Language::Ffi | Language::C => match p {
            PrimitiveType::Bool => "bool".to_string(),
