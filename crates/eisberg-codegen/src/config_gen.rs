use eisberg_core::ir::{DefaultValue, FieldDef, TypeDef, TypeRef};
...
pub fn gen_csharp_record(typ: &TypeDef, namespace: &str, type_mapper: &dyn Fn(&TypeRef) -> String) -> String {
    ...
    lines.push("// This file is auto-generated by eisberg. DO NOT EDIT.".to_string());
...
pub fn default_value_for_field(field: &FieldDef, language: &str) -> String {
    ...
    match &field.ty {
        TypeRef::Primitive(p) => match p {
            eisberg_core::ir::PrimitiveType::Bool => match language {
            ...
            eisberg_core::ir::PrimitiveType::U8
            | eisberg_core::ir::PrimitiveType::U16
            | eisberg_core::ir::PrimitiveType::U32
            | eisberg_core::ir::PrimitiveType::U64
            | eisberg_core::ir::PrimitiveType::I8
            | eisberg_core::ir::PrimitiveType::I16
            | eisberg_core::ir::PrimitiveType::I32
            | eisberg_core::ir::PrimitiveType::I64
            | eisberg_core::ir::PrimitiveType::Usize
            | eisberg_core::ir::PrimitiveType::Isize => "0".to_string(),
...
mod tests {
    use super::*;
    use eisberg_core::ir::{FieldDef, PrimitiveType, TypeRef};
