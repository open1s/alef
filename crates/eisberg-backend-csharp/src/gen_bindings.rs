...
use eisberg_codegen::naming::to_csharp_name;
...
fn gen_wrapper_class(
    ...
    for typ in &api.types {
        ...
        for method in &typ.methods {
            ...
            if let eisberg_core::ir::TypeRef::Named(ref name) = method.return_type {
...
fn gen_enum(enum_def: &EnumDef, namespace: &str) -> String {
    let mut out = String::from("// This file is auto-generated by eisberg. DO NOT EDIT.\n\n");
