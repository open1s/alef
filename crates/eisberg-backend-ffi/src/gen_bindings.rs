...
use eisberg_core::ir::{
    ApiSurface, EnumDef, FieldDef, FunctionDef, MethodDef, ParamDef, ReceiverKind, TypeDef, TypeRef,
};
...
fn gen_lib_rs(api: &ApiSurface, prefix: &str, config: &SkifConfig) -> String {
    ...
    for enum_def in &api.enums {
        if eisberg_codegen::conversions::can_generate_enum_conversion(enum_def) {
    ...
    let _adapter_bodies = eisberg_adapters::build_adapter_bodies(config, Language::Ffi).unwrap_or_default();
...
fn gen_value_to_c(expr: &str, ty: &TypeRef, indent: &str) -> String {
    ...
    match ty {
        TypeRef::Primitive(p) => {
            ...
            if matches!(p, eisberg_core::ir::PrimitiveType::Bool) {
    ...
    if param.optional {
        ...
        match &param.ty {
            ...
            TypeRef::Primitive(prim) => match prim {
                eisberg_core::ir::PrimitiveType::Bool => {
...
fn gen_cbindgen_toml(prefix: &str) -> String {
    ...
    format!(
        r#"# This file is auto-generated by eisberg. DO NOT EDIT.
language = "C"
include_guard = "{prefix_upper}_H"
pragma_once = true
autogen_warning = "/* This file is auto-generated by eisberg. DO NOT EDIT. */"
