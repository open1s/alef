...
use eisberg_codegen::naming::to_go_name;
...
impl Backend for GoBackend {
    ...
    fn generate_bindings(&self, api: &ApiSurface, config: &SkifConfig) -> anyhow::Result<Vec<GeneratedFile>> {
        ...
        let _adapter_bodies = eisberg_adapters::build_adapter_bodies(config, Language::Go)?;
...
fn gen_param_to_c(param: &eisberg_core::ir::ParamDef) -> String {
...
fn type_name(ty: &TypeRef) -> String {
    match ty {
        ...
        TypeRef::Primitive(p) => match p {
            ...
            eisberg_core::ir::PrimitiveType::U8 => "U8".to_string(),
            eisberg_core::ir::PrimitiveType::U16 => "U16".to_string(),
            eisberg_core::ir::PrimitiveType::U32 => "U32".to_string(),
            eisberg_core::ir::PrimitiveType::U64 => "U64".to_string(),
            eisberg_core::ir::PrimitiveType::I8 => "I8".to_string(),
            eisberg_core::ir::PrimitiveType::I16 => "I16".to_string(),
            eisberg_core::ir::PrimitiveType::I32 => "I32".to_string(),
            eisberg_core::ir::PrimitiveType::I64 => "I64".to_string(),
            eisberg_core::ir::PrimitiveType::F32 => "F32".to_string(),
            eisberg_core::ir::PrimitiveType::F64 => "F64".to_string(),
            eisberg_core::ir::PrimitiveType::Usize => "Usize".to_string(),
