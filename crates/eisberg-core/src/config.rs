...
/// Root configuration from eisberg.toml.
...
pub struct SkifConfig {
    ...
    /// Declare opaque types from external crates that eisberg can't extract.
...
/// Custom modules that eisberg should declare (mod X;) but not generate.
