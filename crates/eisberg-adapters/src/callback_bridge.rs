use eisberg_core::config::{AdapterConfig, Language, SkifConfig};
...
pub fn generate(adapter: &AdapterConfig, language: Language, config: &SkifConfig) -> anyhow::Result<(String, String)> {
...
fn gen_python_body(adapter: &AdapterConfig, _config: &SkifConfig) -> (String, String) {
...
fn gen_node_body(adapter: &AdapterConfig, _config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
...
fn gen_ruby_body(adapter: &AdapterConfig, _config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
...
fn gen_php_body(adapter: &AdapterConfig, _config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
...
fn gen_elixir_body(adapter: &AdapterConfig, _config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
...
fn gen_wasm_body(adapter: &AdapterConfig, _config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
...
fn gen_ffi_body(adapter: &AdapterConfig, config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
...
fn gen_go_body(adapter: &AdapterConfig, config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
    let prefix = config.ffi_prefix();
...
fn gen_java_body(adapter: &AdapterConfig, config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
    let prefix = config.ffi_prefix();
...
fn gen_csharp_body(adapter: &AdapterConfig, config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
    let prefix = config.ffi_prefix();
...
fn gen_r_body(adapter: &AdapterConfig, _config: &SkifConfig) -> (String, String) {
    let name = &adapter.name;
