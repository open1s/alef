...
pub fn generate_body(adapter: &AdapterConfig, language: Language, config: &SkifConfig) -> anyhow::Result<String> {
...
fn gen_python_body(adapter: &AdapterConfig, _config: &SkifConfig) -> String {
...
fn gen_node_body(adapter: &AdapterConfig, _config: &SkifConfig) -> String {
    let core_path = &adapter.core_path;
    let returns = adapter.returns.as_deref().unwrap_or("()");
...
fn gen_ruby_body(adapter: &AdapterConfig, _config: &SkifConfig) -> String {
    let core_path = &adapter.core_path;
    let returns = adapter.returns.as_deref().unwrap_or("()");
...
fn gen_php_body(adapter: &AdapterConfig, _config: &SkifConfig) -> String {
    let core_path = &adapter.core_path;
    let returns = adapter.returns.as_deref().unwrap_or("()");
...
fn gen_elixir_body(adapter: &AdapterConfig, _config: &SkifConfig) -> String {
    let core_path = &adapter.core_path;
    let returns = adapter.returns.as_deref().unwrap_or("()");
...
fn gen_wasm_body(adapter: &AdapterConfig, _config: &SkifConfig) -> String {
    let core_path = &adapter.core_path;
...
fn gen_ffi_body(adapter: &AdapterConfig, config: &SkifConfig) -> String {
    let core_path = &adapter.core_path;
...
fn gen_go_body(adapter: &AdapterConfig, config: &SkifConfig) -> String {
    let name = &adapter.name;
    let prefix = config.ffi_prefix();
...
fn gen_java_body(adapter: &AdapterConfig, config: &SkifConfig) -> String {
    let name = &adapter.name;
    let prefix = config.ffi_prefix();
...
fn gen_csharp_body(adapter: &AdapterConfig, config: &SkifConfig) -> String {
    let name = &adapter.name;
    let prefix = config.ffi_prefix();
...
fn gen_r_body(adapter: &AdapterConfig, _config: &SkifConfig) -> String {
    let core_path = &adapter.core_path;
